...
ssp.init(function () {
    ...
    ssp.on('ready', function () {
        ...
        ssp.enable();
        ssp.commands.get_denomination_route(0x64, 0x00, 0x00, 0x00 )
        ssp.commands.set_denomination_route(0x00, 0x64, 0x00, 0x00)
        ssp.commands.get_denomination_level(0x64, 0x00, 0x00, 0x00)
        // ssp.commands.payout_amount(0xC8, 0x00, 0x00, 0x00, 0x55, 0x53, 0x44, 0x58)
